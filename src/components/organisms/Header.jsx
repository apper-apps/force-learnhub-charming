...
{/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link
              to="/my-learning"
              className="flex items-center space-x-2 px-4 py-2 ml-2 rounded-lg font-medium transition-all duration-200 group bg-gradient-to-r from-accent-500 to-accent-600 text-white hover:from-accent-600 hover:to-accent-700 hover:shadow-lg transform hover:scale-105"
            >
              <ApperIcon 
                name="Play" 
